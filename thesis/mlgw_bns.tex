...
As we shall discuss in section \ref{sec:evaluation-time}, the second-slowest part of the reconstruction for a waveform is the inclusion of extrinsic parameters, in points \ref{item:item:rescale} and \ref{item:polarizations}. 
