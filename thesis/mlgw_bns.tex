...
Note that the term ``slow'' is relative here: \texttt{TEOBResumS} is quite fast compared to the alternatives which accurately capture the dynamics up to merger, which makes it a good choice for the training of \ac{mb} since it allows for the quick generation of relatively large datasets.
This also means that the margin of improvement for the 
