...
% I would like to thank the Jena group at the TPI, especially Rossella Gamba, Matteo Breschi and my advisor Sebastiano Bernuzzi, as well as Stefano Schmidt, for many helpful discussions;

% my friends in the Galileian School, especially Giorgio, Leonardo, Alessandro, Lorenzo and my dear Davide;

% the professors who have inspired me the most: profs.\ Mapelli, Turolla, Ciani, Liguori, Matarrese, Passera;

% Michele Maggiore for his wonderful books, which also inspired the typographic style of this thesis;

% my friends in the Assiscout groups in Pordenone and Fiesso d'Artico; 

% my friends from the physics and astronomy degrees;
