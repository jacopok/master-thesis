...
\begin{itemize}
    ...
    \item phase unwrapping (\ref{sec:unwrapping})
...
\begin{itemize}
    ...
    \item PCA training (\ref{sec:principal-component-analysis})
\end{itemize}};
...
\begin{itemize}
    \addtolength{\itemindent}{-.5cm}
    \item optimization (\ref{sec:optuna})
...
\begin{itemize}
    \addtolength{\itemindent}{-.5cm}
    \item intrinsic parameter rescaling
    \item NN evaluation
\end{itemize}
};

\node (params) [parameters, below of=nn2, yshift=-.7cm] {user parameters \((q, \Lambda_1, \Lambda_2, \chi_1, \chi_2, M, D_L, \iota, t_0, \phi_0)\)};
