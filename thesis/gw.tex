...
Compact objects can spin, and the spin of each of the two is a vector with three different components. 
...
The meaning of \(\Lambda \) is less immediate ---  the first correction to the phasing of the waveform which appears is \cites[eq.\ 14.231]{maggioreGravitationalWavesVolume2018}{flanaganConstrainingNeutronStar2008}
%
\begin{align}
