...
\subsubsection{Matched filtering: finding the signal}
...
This random walk will eventually converge to the 
...
One option we have is to estimate waveforms by running full \ac{NR} simulations.
This is useful but extremely computationally expensive. 
