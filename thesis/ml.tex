...
This sounds good, but there is a problem: a procedure as described can get arbitrarily low costs by learning \emph{specific features} of the training dataset which will not generalize. This is known as \emph{overfitting}. 
Its counterpart, \emph{underfitting}, may happen when our model is not powerful enough 
% How do we avoid this issue? 
The parameters \(\beta \) can typically be adapted to avoid 
